...
import SimEngine
import SimVersion
from DotBot import DotBot
from Floorplan import Floorplan
from Orchestrator import Orchestrator
from RunSim import SimSettings
...
class SimUI(object):
    ...
    def __init__(self, floorplan: Floorplan, dotbots: list[DotBot], orchestrator: Orchestrator,
    ...
    def _webhandle_dotbots_GET(self):
        ...
        returnVal = {
            ...
            'robotRadius': self.simSetting.robot_radius,
            'showRadius': self.simSetting.show_radius,
            'showRipsComplex': self.simSetting.show_rips_complex,
    ...
    @staticmethod
    def _bottle_try_running_forever(*args, **kwargs):
        RETRY_PERIOD = 3
        while True:
            try:
